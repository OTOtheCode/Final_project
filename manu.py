...
class ClinicAccountingMenu:
    ...
    def display(self):
        while True:
            print("1. Calculate cost of the procedure: ") 
            print("2. Calculate salary for staff member: ")                     
            print("3. View services that hospital is providing: ")                           
            print("4. View last monthes income: ")         
            print("5. Exit")
